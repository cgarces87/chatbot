...
async function crearEvento({ titulo, descripcion, inicio, fin, todoElDia, duracionMin, invitadoEmail, recordatorioMin }) {
  ...
  return { id: r.data.id, link: r.data.htmlLink, titulo: r.data.summary, inicio: r.data.start, fin: r.data.end };
}
